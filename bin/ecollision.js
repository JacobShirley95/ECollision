...
},{"./engine/simulation-engine":2,"./events/event-manager":3,"./settings":8,"./ui/graph":9,"./ui/overlay":10,"./ui/simulation":11}],2:[function(require,module,exports){
// Generated by CoffeeScript 1.10.0
(function() {
...
},{"../math/pvector":5,"../objects/particle":6}],3:[function(require,module,exports){
// Generated by CoffeeScript 1.10.0
...
// Generated by CoffeeScript 1.10.0
(function() {
  var EventManager, Particle, Simulation, Widget,
    extend = function(child, parent) { for (var key in parent) { if (hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; },
    hasProp = {}.hasOwnProperty;
  ...
  module.exports = Simulation = (function(superClass) {
    ...
    Simulation.prototype.addParticle = function(x, y, mass, radius, style) {
      ...
      particle.mass = mass;
      particle.addListener("click", (function(_this) {
        return function(ev, particle) {
          if (selected !== null) {
            selected.deselect();
            _this.fire("deselect", [selected]);
          }
          if (particle !== selected) {
            _this.fire("select", [particle]);
            selected = particle;
            return particle.select();
          } else {
...
},{"../events/event-manager":3,"../objects/particle":6,"./widget":12}],12:[function(require,module,exports){
// Generated by CoffeeScript 1.10.0
(function() {
  var Widget;
